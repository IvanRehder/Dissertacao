...
\input{Resultados/Nasa/Tabelas/md_table_blind}
...
\input{Resultados/Nasa/Tabelas/blocanova_md_avg_two_way_blind}
...
\input{Resultados/Nasa/Tabelas/md_var_average_group_blind.tex}
...
\input{Resultados/Nasa/Tabelas/nasa_table_blind}
...
%
%\input{Resultados/Nasa/Tabelas/nasa_average_group_blind}
...
\begin{figure}[!htb]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width = 0.8\linewidth]{Resultados/Nasa/Figuras/png/qqplot_nasa_avg_two_way_blind.png}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width = 0.8\linewidth]{Resultados/Nasa/Figuras/png/residplot_nasa_avg_two_way_blind.png}
...
\input{Resultados/Nasa/Tabelas/blocanova_nasa_avg_two_way_blind}
