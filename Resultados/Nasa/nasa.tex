...
%\input{Resultados/Nasa/Tabelas/md_average}
...
\input{Resultados/Nasa/Tabelas/bloctwowayanova_mental_demand_avg.tex}
...
%\input{Resultados/Nasa/Tabelas/blocanova_mental_demand_avg.tex}
%
%\input{Resultados/Nasa/Tabelas/lsd_mental_demand_avg.tex}
%
\input{Resultados/Nasa/Tabelas/md_table_noBase.tex}
%
\input{Resultados/Nasa/Tabelas/md_table_blind.tex}
...
\begin{table}[!htb]
    \begin{minipage}{.45\linewidth}
        \input{Resultados/Nasa/Tabelas/shapiro_nasa_scoreSemBegin.tex}
    \end{minipage}
    \hfill
    \begin{minipage}{.45\linewidth}
        \vspace{-2.75cm}
...
\input{Resultados/Nasa/Tabelas/blocanova_nasa_var.tex}
