...
\input{Resultados/GSR/Tabelas/gsr_table}

%\begin{figure}[!htb]
%    \centering
%    \resizebox{0.6\linewidth}{!}{
%    \input{Resultados/GSR/Figuras/barplot_gsr_scene_blind.pgf}
%    }
...
\begin{figure}[!htb]
    ...
    %\resizebox{0.6\linewidth}{!}{
    %\input{Resultados/GSR/Figuras/boxplot_gsr_scene.pgf}    
    %}
...
\input{Resultados/GSR/Tabelas/gsr_variation.tex}
%
%\begin{figure}[!htb]
%    \centering
%    \resizebox{0.6\linewidth}{!}{
...
\input{Resultados/GSR/Tabelas/shapiro_gsr}
...
\input{Resultados/GSR/Tabelas/ttest_gsr}
...
\input{Resultados/GSR/Tabelas/anova_gsr.tex}
