...
%        %\input{Resultados/GSR/Figuras/barplot_ecg_bpm_scene_blind.pgf}
%        %}
...
%        %\input{Resultados/GSR/Figuras/barplot_gsr_scene_sight.pgf}    
%        %}
...
%\input{Resultados/GSR/Tabelas/gsr_avg_table_def2.tex}
...
%\begin{table}[!htb]
%    \begin{minipage}{.45\linewidth}
%        \input{Resultados/GSR/Tabelas/shapiro_gsr_avgSemBegin.tex}
%    \end{minipage}
%    \hfill
%    \begin{minipage}{.45\linewidth}
%        \vspace{-2.75cm}
%        \input{Resultados/GSR/Tabelas/ttest_gsr_avgSemBegin.tex}
%    \end{minipage}
%\end{table}
...
%\input{Resultados/GSR/Tabelas/blocanova_gsr_avg.tex}
...
%\input{Resultados/GSR/Tabelas/lsd_gsr_avg.tex}
...
%\input{Resultados/GSR/Tabelas/gsr_sum_table}
%\input{Resultados/GSR/Tabelas/gsr_sum_table_blind}
...
%\input{Resultados/GSR/Tabelas/gsr_sum_table_etp.tex}
%
%\input{Resultados/GSR/Tabelas/gsr_var_sum_def_blind.tex}
%
%\input{Resultados/GSR/Tabelas/gsr_var_sum_def.tex}
...
%\begin{table}[!htb]
%    \begin{minipage}{.45\linewidth}
%        \input{Resultados/GSR/Tabelas/shapiro_gsr_sumSemBegin.tex}
%    \end{minipage}
%    \hfill
%    \begin{minipage}{.45\linewidth}
%        \vspace{-2.75cm}
%        \input{Resultados/GSR/Tabelas/ttest_gsr_sumSemBegin.tex}
%    \end{minipage}
%\end{table}

%The Table \ref{tab:repblocanova_gsr} shows the Anova test p-value of the skin conductance frequency of the "blind" sample between the guidance methods presented in the Table \ref{tab:gsr_avg_table}. The p-value indicates that there is at least one method that is statistically equal to one of the other methods.

%\input{Resultados/GSR/Tabelas/blocanova_gsr_sum.tex}

%The Table \ref{tab:lsd_gsr} presents the conclusion of a pairwise Fisher LSD test of the blind skin conductance frequency variation between all the guidance methods. The results show that the "Virtual Cane" and the "Mixture" have different variations, but since they are not normally distributed this conclusion can not statistically be made.

%\input{Resultados/GSR/Tabelas/lsd_gsr_sum.tex}
