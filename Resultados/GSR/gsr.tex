...
\input{Resultados/GSR/Tabelas/gsr_var_average_group.tex}
...
\begin{table}[!htb]
    \begin{minipage}{.45\linewidth}
        \input{Resultados/GSR/Tabelas/shapiro_gsrSemBegin.tex}
    \end{minipage}
    \hfill
    \begin{minipage}{.45\linewidth}
        \vspace{-2.75cm}
...
\input{Resultados/GSR/Tabelas/repblocanova_gsr.tex}
