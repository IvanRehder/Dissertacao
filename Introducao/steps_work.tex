\begin{figure}[!htb]
    ...
    \begin{tikzpicture}[node distance = 3cm]
        ...
        \node (ve) [steps, below of=examples, left of = examples, xshift = -1cm] {Step 3 - Development of the VE};
        \draw [arrow] (examples) to ++(0,-1.5cm) to ++(-4.0cm,0) to node[midway,right]{} (ve.north);
        
        \node (devices) [steps, below of=examples, right of = examples, xshift = 1cm] {Step 4 - Development of the assistive devices};
        \draw [arrow] (examples) to ++(0,-1.5cm) to ++(4.0cm,0) to node[midway,right]{} (devices.north);

        \node (experiment) [steps, below of=devices, left of = devices, xshift = -1cm] {Step 5 - Design and execution of the experiment};
        ...
        \node (analysis) [steps, below of=experiment, yshift = 0.5cm] {Step 6 – Analysis of results};
