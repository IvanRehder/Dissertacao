Bradley and Dunlop wrote two works about BVI navigation, one in \citeyear{bradley2002investigating} and the last in \citeyear{bradley2005experimental}. 
...
\input{Revisao/Bradley Dunlop/Grafico_2002_2}
...
\begin{minipage}{.45\linewidth}
    ...
    \captionof{figure}{Mean times for each landmark performed by the sighted participants (Adapted from \citeonline{bradley2005experimental}).}
...
\begin{minipage}{.45\linewidth}
    \centering
    \resizebox{\linewidth}{!}{
    \input{Revisao/Bradley Dunlop/Grafico_2005_Nasa_4}
    }
    \captionof{figure}{Mean times for each landmark performed by the BVI participants (Adapted from \citeonline{bradley2005experimental}).}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.45\textwidth}
        ...
        \input{Revisao/Bradley Dunlop/Grafico_2005_Nasa_5}
        }
    ...
    \end{subfigure}
\caption{Comparison of the NASA-TLX between the conditions (Adapted from \citeonline{bradley2005experimental}).}
