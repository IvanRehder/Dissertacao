\begin{figure}[!htb]
    ...
    \begin{tikzpicture}[node distance=1cm]
        ...
        \node (interview) [phase] {Interview's phase};
        \node (interview_hospital) [task, below of = interview, yshift = -2cm] {Interview with hospitals};
        \node (interview_bvi) [task, below of = interview_hospital, yshift = -3.5cm] {Interview with BVI consultants};
        
        \node (a1) [right of = interview, above of = interview, xshift = 2.0cm] {};
        \node (a2) [below of = a1, yshift = -11cm] {};
        \draw [--gray] (a1) to (a2);
        
        \node (scope) [phase] [phase, right of = interview, xshift = 5cm] {Scope's phase};
        \node (virtual_environment) [task, below of = scope, yshift = -2cm] {Virtual environment definition};
        \node (human_factors) [task, below of = virtual_environment, yshift = -2cm] {Assessed human factors definition};
        \node (guidance_methods) [task, below of = human_factors, yshift = -2cm] {Guidance methods definition};
        
        \node (b1) [right of = scope, above of = scope, xshift = 2.0cm] {};
        \node (b2) [below of = b1, yshift = -11cm] {};
        \draw [--gray] (b1) to (b2);
        
        \node (development) [phase] [phase, right of = scope, xshift = 5cm] {Development's phase};
        \node (ve_creation) [task, below of = development, yshift = -2cm] {Virtual scenes creation};
        \node (tools_definition) [task, below of = ve_creation, yshift = -2cm] {Tools and methods definition};
        \node (guidance_development) [task, below of = tools_definition, yshift = -2cm] {Guidance methods development};
        
        \node (c1) [right of = development, above of = development, xshift = 2.0cm] {};
        \node (c2) [below of = c1, yshift = -11cm] {};
        \draw [--gray] (c1) to (c2);
        
        \node (tryouts) [phase] [phase, right of = development, xshift = 5cm] {Tryout's phase};
        \node (tryouts_task) [task, below of = tryouts, yshift = -5.0cm] {Tryouts};
        
        \node (d1) [right of = tryouts, above of = tryouts, xshift = 2.0cm] {};
        \node (d2) [below of = d1, yshift = -11cm] {};
        \draw [--gray] (d1) to (d2);
        
        \node (experiment) [phase] [phase, right of = tryouts, xshift = 5cm] {Experiment's phase};
        \node (experiment_task) [task, below of = experiment, yshift = -5.0cm] {Experiments};
