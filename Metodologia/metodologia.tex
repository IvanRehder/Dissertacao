...
In the last case, the experiment should provide feedback on improving the devices' specification, refine the assessment methods, expand the virtual environment to include new tasks and/or situations, or even abandon a device concept. Each evaluation cycle should increase the maturity of the assistive devices under development.
...
\label{sec:idealization_phase}
    ...
    \subsection*{\textit{Step 2.3 Guidance specification}}
        ...
        It was also pointed out that the assessment should compare these four methods and the familiar guidance method of the BVI participants among them (e.g. white cane) with each other.
...
\label{sec:creation_phase}
    ...
    \subsection*{\textit{Step 3.2 Proposal of assessment methods and tools}}
        ...
        \begin{itemize}
            ...
            \item NASA-TLX subjective questionnaire (Appendix \ref{apsec:nasa_tlx}).           
        \end{itemize}
        ...
        Finally, a questionnaire is proposed for evaluating the guidance methods. This questionnaire was also guided by the same blind consultant from the Adapted SAGAT questionnaire. The consultant was asked to make questions about each method that he considered necessary for an assistive device to have and he focused on the comfort, the sense of safety, the sense of confusion and on the precision that the manipulation of the device caused. This questionnaire is on Appendix \ref{apsec:guidace_evaluation}.
